...
# should be on PATH (for example in ~/aavs-calibration/)
echo "Lfile2uvfits_eda.sh -i ${timeres} -n 1 -N 512 -C 32 -f ${channel}  -F -s eda2 ${lfile} >> lfile2uvfits.out 2>&1"
Lfile2uvfits_eda.sh -i ${timeres} -n 1 -N 512 -C 32 -f ${channel}  -F -s eda2 ${lfile} >> lfile2uvfits.out 2>&1
